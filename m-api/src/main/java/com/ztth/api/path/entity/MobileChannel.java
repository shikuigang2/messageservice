...
public class MobileChannel {
    ...
    /**
     * 获取短信发送数量，也可做可发送短信数量 暂不明确
     *
     * @return msgCount - 短信发送数量，也可做可发送短信数量 暂不明确
     */
    ...
    /**
     * 设置短信发送数量，也可做可发送短信数量 暂不明确
     *
     * @param msgcount 短信发送数量，也可做可发送短信数量 暂不明确
     */
